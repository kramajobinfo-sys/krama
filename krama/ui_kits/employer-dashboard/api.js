...
(function () {
  ...
  window.KRAMA_EMPLOYER_API = {
    ...
    getJobFeed: function () { return req("GET", "/employer/job-feed"); },
    saveJobFeed: function (data) { return req("PUT", "/employer/job-feed", data); },
    syncJobFeed: function () { return req("POST", "/employer/job-feed/sync"); },
    deleteJobFeed: function () { return req("DELETE", "/employer/job-feed"); },
