...
(function init() {
        ...
        <div className="krm-table-wrap"><Card padding={0}>
          ...
          {!loading && companies.map((c, i) => (
            <div key={c.id} style={{ display: "grid", gridTemplateColumns: "2fr 1.3fr 1.1fr 0.6fr 0.9fr 270px", alignItems: "center", padding: "14px 20px", borderBottom: i < companies.length - 1 ? "1px solid var(--border-subtle)" : "none" }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", alignItems: "center" }}>
                <label title={c.cover_banner_url ? "Replace cover banner" : "Upload cover banner"} style={{ display: "inline-flex", alignItems: "center", gap: 5, height: 30, padding: "0 10px", borderRadius: "var(--radius-sm)", cursor: coverBusy === c.id ? "wait" : "pointer", border: "1px solid " + (c.cover_banner_url ? "var(--brand)" : "var(--border-strong)"), background: c.cover_banner_url ? "var(--brand-subtle)" : "var(--surface-card)", color: c.cover_banner_url ? "var(--text-brand)" : "var(--text-muted)", fontFamily: "var(--font-sans)", fontSize: "var(--text-xs)", fontWeight: 700, flexShrink: 0 }}>
  ...
  function Homepage() {
    ...
    const ICON_SET = [{ value: "sparkles", label: "Sparkles" }, { value: "rocket", label: "Rocket" }, { value: "bell", label: "Bell" }, { value: "gift", label: "Gift" }, { value: "building-2", label: "Building" }, { value: "badge-check", label: "Verified" }, { value: "star", label: "Star" }, { value: "trending-up", label: "Trending" }, { value: "briefcase", label: "Briefcase" }];
        ...
        {(function() {
          ...
          <Card padding={24} style={{ marginTop: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <div>
                <h3 style={{ fontSize: "var(--text-lg)", fontWeight: 700, color: "var(--text-strong)" }}>Find Jobs -- Hero heading</h3>
        ...
        {(function() {
          ...
          <Card padding={24} style={{ marginTop: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 36, height: 36, borderRadius: "var(--radius-md)", background: "var(--teal-50)", color: "var(--teal-700)" }}>{I("layout-panel-top", 18)}</span>
              <div>
                <h3 style={{ fontSize: "var(--text-lg)", fontWeight: 700, color: "var(--text-strong)" }}>Companies -- Hero heading</h3>
