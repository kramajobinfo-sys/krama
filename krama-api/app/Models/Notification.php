...
class Notification extends Model
{
    ...
    public static function record($userId, string $type, string $title, ?string $body = null): void
    {
        if (! $userId) return;
    ...
    public static function recordAdmins(string $type, string $title, ?string $body = null): void
    {
